      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-lg">Love to build things and learn new things</p>
            <p className="text-muted-foreground text-lg">Utilize my best skills to build things that are useful and impact people's lives</p>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Leading projects from conception to completetion with agile
                    methodologies.
                  </p>
                </div>
              </div>
